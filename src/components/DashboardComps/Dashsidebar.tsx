...
const Dashsidebar = ({ role }: DashsidebarProps) => {
  const { open, setOpen } = useSidebar()
  const isSeller = role === 'seller'

  return (
    <main className={`flex flex-col bg-white max-h-screen right-[0] z-[100]
      ...
      <div className='flex flex-col gap-4 px-5 flex-1 overflow-y-auto' dir='ltr'>
        ...
        {isSeller && (
          <>
            ...
            <SideBarButton href="/CustomersReservationList" className='flex flex-row justify-end items-center'>
              مدیریت رزرو ها
              <Image src={Add} alt='Add' width={20} height={20} />
            </SideBarButton>

            <SideBarButton href="/SellerPaymentSection" className='flex flex-row justify-end items-center'>
              مدیریت مالی
              <Image src={Desk} alt='Desk' width={20} height={20} />
            </SideBarButton>

            <SideBarButton href="/SellerComments" className='flex flex-row justify-end items-center'>
              مدیریت نظرات
        ...
        {!isSeller && (
          <>
            ...
            <SideBarButton href="/BuyerPayment" className='flex flex-row justify-end items-center'>
              پرداخت ها
              <Image src={Desk} alt='Desk' width={20} height={20} />
            </SideBarButton>
          </>
        ...
        <SideBarButton href="/Notifactions4u" className='flex flex-row justify-end items-center'>
          اعلان ها
