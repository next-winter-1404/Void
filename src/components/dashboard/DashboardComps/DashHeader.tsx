...
import DarkButton from "@/components/darkmode/darkmodeBt";
...
export default function DashHeader() {
  ...
  return (
    <header className={`flex items-center justify-between p-3 md:p-4 ${theme === "dark" ? "bg-[#444444]" : theme === "light" ? "bg-white" : "bg-[#444444]"} border border-gray-200 rounded-2xl shadow-sm w-full`}>
      ...
      <div className="flex items-center gap-2 md:gap-4" dir='ltr'>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          <button onClick={()=>redirect("/home")} className=' rounded-full w-8 h-8'><Image alt='home' src={HOME} /> </button>
